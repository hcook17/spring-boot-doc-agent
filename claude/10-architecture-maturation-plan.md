...
>
> **§0–1 and the JPA survey are outdated planning text**, not executable specs. The DDIA thesis was revalidated by [`claude/research/fact-store-phase1-decision-memo-2026-07-30.md`](research/fact-store-phase1-decision-memo-2026-07-30.md) (**REFINE**). **Phase 1 = thin dual-emit** (`facts.jsonl` beside `spring_signals.json` per [`research/facts-ledger-schema-2026-07-30.md`](research/facts-ledger-schema-2026-07-30.md)) — not a walk of this file’s phase checklist. Contested `entity_table_map` remains; maps are not replaced in Phase 1.
>
