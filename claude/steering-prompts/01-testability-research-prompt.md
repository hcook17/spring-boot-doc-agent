...
verify:
  - path_exists:tests/test_pipeline_stages.py
...
Deliver as `scripts/test_pipeline_stages.py`, following the existing suites' skip-if-fixture-absent pattern, and update `SKILL.md`/`README.md` to mention how to run it.
