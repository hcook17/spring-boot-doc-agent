#!/usr/bin/env python3
"""
test_drift_normalization.py — how often does spring_drift_check tier 2 report
...
test_spring_drift_check.py owns tier 2's unit-level behaviour: that each
...
the fix usually belongs in test_spring_drift_check.py as a named unit case,
