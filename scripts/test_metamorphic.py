...
Not covered by sibling suites. test_set_delta.py pins what the relations mean
(pure set arithmetic, no scanning). test_drift_normalization.py measures a
...
FIXTURES = Path(__file__).resolve().parent / "rule_fixtures"
