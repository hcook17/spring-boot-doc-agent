...
`test_pipeline_stages.py` held hand-copied duplicates of `agents/*.md`'s
...
Not covered by sibling suites. `test_pipeline_stages.py` checks that *output*
...
import test_pipeline_stages as stages  # noqa: E402
...
class ContractsMatchTheValidatorsTest(unittest.TestCase):
    ...
    def test_spring_roles_matches_the_prompt(self) -> None:
        self.assertEqual(pc.spring_roles(), stages.VALID_SPRING_ROLES)

    def test_file_summary_keys_match_the_prompt(self) -> None:
        self.assertEqual(pc.file_summary_keys(), stages.FILE_SUMMARY_REQUIRED_KEYS)
...
class PromptEditGoesRedTest(unittest.TestCase):
    ...
    def test_adding_a_role_to_the_prompt_is_detected(self) -> None:
        ...
        self.assertNotEqual(pc.spring_roles(), stages.VALID_SPRING_ROLES)
    ...
    def test_renaming_a_json_key_in_the_prompt_is_detected(self) -> None:
        ...
        self.assertNotEqual(pc.file_summary_keys(), stages.FILE_SUMMARY_REQUIRED_KEYS)
