 ...
 * all 48 @RestController. Wave 2 fixes this by routing through isOrMeta,
 * which picks these up from SpringMetaEdges.qll with the discovery switch
 * still closed -- no probe needed. It also misses the
