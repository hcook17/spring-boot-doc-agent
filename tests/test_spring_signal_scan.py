...
# Scanner set used for the fixture snapshot.  CodeQL is the production default,
# but the snapshot is recorded with ast-grep so it can be exercised in
# environments where a compatible Java toolchain for CodeQL is not available.
