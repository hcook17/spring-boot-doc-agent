...
file tree, rather than the synthetic scenarios in test_partition_repo.py.
...
part of the regular test_partition_repo.py suite and isn't required for
that suite to pass.
...
class RealRepoTest(unittest.TestCase):
    ...
    def test_no_group_is_a_wild_outlier(self):
        ...
        # build_groups() comments and test_partition_repo.py's
