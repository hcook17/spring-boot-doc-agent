...
2. Optionally, the same validators against a *real* completed pipeline run's
   ...
   skip-if-absent pattern as tests/doc_engine/test_partition_repo_real_world.py's
...
Opt-in real-artifacts pass:
    PIPELINE_ARTIFACTS_DIR=/path/to/completed/run/output pytest tests/doc_engine/test_pipeline_stages.py -v
"""
